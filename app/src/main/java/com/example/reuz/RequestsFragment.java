...
public class RequestsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, RequestsViewHolder> adapter =
            ...
            @Override
            protected void onBindViewHolder(@NonNull final RequestsViewHolder holder, int position,
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    if (task.isSuccessful()) {
                                                                        ContactsRef.child(list_user_id).child(currentUserID).child("Contacts")
                                                                            ...
                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                if (task.isSuccessful()) {
                                                                                    ChatsRequestsRef.child(currentUserID).child(list_user_id)
                                                                                            .removeValue()
                                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                @Override
                                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                                    if (task.isSuccessful()) {
                                                                                                        ChatsRequestsRef.child(list_user_id).child(currentUserID)
                                                                                                                .removeValue()
                                                                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                    @Override
                                                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                            ...
                                                                            if (task.isSuccessful()) {
                                                                                ChatsRequestsRef.child(list_user_id).child(currentUserID)
                                                                                        ...
                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                            ...
                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                if (task.isSuccessful()) {
                                                                                                    Toast.makeText(getContext(), "you have cancelled chat request...",
